...
{
  public $product, $type_variant, $categories, $subcategories, $brands, $slug;
  ...
  public function changeVariant($newValue, $confirm)
  {
    if (!$confirm) {
      ...
      $product->type_variant = $newValue;
      $product->save();
      $this->emitTo('admin.upsert-product-variant', 'refreshVariants', $newValue);
    }
  }
