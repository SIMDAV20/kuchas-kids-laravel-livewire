...
<div x-data="{ 
  ...
  <label for="file-{{ $randomId }}" class="relative block leading-tight bg-white hover:bg-gray-100 cursor-pointer inline-flex items-center transition duration-500 ease-in-out group overflow-hidden
    ...
    <div class="absolute inset-0">
      <div class="relative w-full overflow-hidden shadow-inner" style="padding-bottom: 100%">
        ...
        <div
          ...
          <svg class="h-6 w-6 text-gray-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke="currentColor">
    ...
    <div class="flex items-center justify-center flex-1 px-4 py-2" wire:loading.class="hidden"
      ...
      @if($multiple)
      <svg
        class="-mr-5 -mt-2 transform -rotate-6 h-8 w-8 text-gray-300 group-hover:text-indigo-300 transition duration-500 ease-in-out"
      ...
      <svg
        class="transition duration-500 ease-in-out relative h-8 w-8 transform rotate-3 text-gray-400 group-hover:text-indigo-500"
        xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 256 256">
        <rect width="256" height="256" fill="none"></rect>
        <path
      ...
      @else
      @if ($mode === 'profile')
      <svg class="h-8 w-8 text-gray-300 group-hover:text-indigo-500" xmlns="http://www.w3.org/2000/svg" fill="none"
