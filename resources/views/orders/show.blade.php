<x-app-layout>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="flex bg-white rounded-lg shadow-lg px-6 sm:px-12 py-8 mb-6 pt-3 items-center">
            <div class="relative">
                <div
        ...
        <div class="bg-white flex md:flex-row flex-col rounded-lg shadow-lg px-6 py-4 mb-6">
            <div class="md:flex w-full items-center">
                <p class="text-gray-700 uppercase grow">
                ...
                <div class="flex items-center justify-end">
                    ...
                    <x-button class="mt-3 md:mt-0" id="anular-pedido" color="red" data-order="{{ $order->id }}">
                        Anular Pedido
                    </x-button>
                    @endif

                    @if ($order->status == 1 && $order->payment_method == null)
                    <x-button-enlace class="mt-3 md:mt-0 ml-3" color="violet" number="350"
                        ...
                        <div class="flex justify-center flex-col items-center w-full">
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="images ml-4 mt-2">
                                    <img src="{{ @Storage::url($order->payment->images->url) }}" alt="" width="100"
    ...
    <script>
        $(".images img").click(function() {
            ...
            $("#anular-pedido").click(function() {
                let orderId = $(this).data('order');

                Swal.fire({
                    title: 'Esta seguro de anular la orden ' + orderId + '?',
                    input: 'text',
                    ...
                    inputValidator: (value) => {
                        if (value.length < 10) {
                            return 'Por favor escribe mayor a 10 caracteres'
                        }
                    },
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                if (response == 'ok') {
                                    Swal.fire(
                                        'Eliminado!',
                                        'La orden ' + orderId + ' ha sido anulada.',
                                        'success'
                                    )
                                    location.reload();
                                }
