<div>
  <div class="bg-white shadow-xl rounded-lg p-6 mt-4">
    ...
    <div class="mb-4">
      ...
      <x-input wire:model="createForm.slug" class="w-full" />
      ...
      <table class="table-auto w-full">
        <thead>
          <tr class="text-xl">
            ...
            <th class="px-4 py-2 w-1/3">Estado</th>
          ...
          @foreach ($variants as $variant)
            <tr wire:key="variant-{{ $variant->id }}" class="text-center">
              ...
              <td class="px-4 py-2 flex">
                ...
                <div>
                  @livewire('admin.gallery-images-products', ['item_id' => $variant->id, 'model' => $model_str[$type_variant]], key('gallery-variant-' . $variant->id))
  ...
  <x-dialog-modal wire:model="open">
    ...
    <x-slot name="content">
      ...
      <div class="my-4">
        ...
        <x-input type="text" wire:model="editForm.slug" class="w-full" />
