        ...
        <tr wire:key="variant-{{ $variant->id }}" class="text-center">
          ...
          <td class="px-4 py-2">
            <div class="flex align-center">
              <div class="w-6 h-6 rounded-full ml-2" style="background-color: {{ $colors->find($variant->color_id)->hex }}"></div>
          ...
          <td class="px-4 py-2 flex">
            <x-secondary-button class="ml-auto mr-2" wire:loading.attr="disabled" wire:target="edit()" wire:click="edit({{ $variant->id }})">
              Actualizar
            </x-secondary-button>
