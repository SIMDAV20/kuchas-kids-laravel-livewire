  ...
  <div class="container py-12">
    ...
    <x-table-responsive>
      ...
      <div class="px-6 py-4">
        ...
        <x-input type="text" wire:model="search" placeholder="Ingrese el nombre del producto que quiere buscar" class="w-full" />
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          ...
          <tr>
            <td class="px-6 py-4 whitespace-nowrap">
              <div class="flex items-center">
                <div class="flex-shrink-0 h-10 w-10">
                  ...
                  <img class="h-10 w-10 rounded-full object-cover" src="{{ Storage::url($product->gallery) }}" alt="{{  $product->gallery }}">
                  @endif
                </div>
                <div class="ml-4">
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
              ...
              <div class="flex items-center mb-2">
                <div class="w-6 h-6 rounded-full mr-2 tooltip-tippy" data-tippy-content="{{ $p_color->color->name }}" style="background-color: {{ $p_color->color->hex }}"></div>
                <p class="text-orange-500 font-bold">
                  {{ $p_color->quantity }}
                </p>
              </div>
