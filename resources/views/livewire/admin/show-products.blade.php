        ...
        <x-table-responsive>
            ...
            <div class="px-6 py-4">
                ...
                <div class="flex-1 relative">
                    ...
                    <div
                        class="absolute top-0 right-0 w-12 h-full bg-gray-350 flex items-center justify-center rounded-r-md">
                                        ...
                                        <div class="flex-shrink-0 h-10 w-10">
                                            @if ($product->images->count())
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    ...
                                                    alt="">
                                            @elseif (count($product->color_product) && count($product->color_product->first()->images))
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="{{ Storage::url($product->color_product->first()->images->first()->url) }}"
                                                    alt="">
                                            @else
                                                <img class="h-10 w-10 rounded-full object-cover"
                                                    src="{{ asset('img/default-image-620x600.jpg') }}" alt="">
                                            @endif
                                        </div>
                                        <div class="ml-4">
