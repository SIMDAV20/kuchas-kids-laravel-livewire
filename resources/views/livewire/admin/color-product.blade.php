        ...
        <tr wire:key="color_product-{{ $color_product->pivot->id }}" class="text-center">
          <td class="capitalize px-4 py-2">
            <div class="flex items-center justify-start">
              ...
              <div class="w-6 h-6 rounded-full ml-2" style="background-color: {{ $colors->find($color_product->pivot->color_id)->hex }}">
              </div>
            </div>
          </td>
          <td class="px-4 py-2">
          ...
          <td class="px-4 py-2 flex">
            <x-secondary-button class="ml-auto mr-2" wire:loading.attr="disabled" wire:target="edit()" wire:click="edit({{ $color_product->pivot->id }})">
              Actualizar
            </x-secondary-button>
