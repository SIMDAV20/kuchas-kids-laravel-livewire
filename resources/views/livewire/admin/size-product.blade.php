                ...
                <tbody>
                    @foreach ($product_sizes as $product_size)
                        <tr wire:key="product_size-{{ $product_size->pivot->id }}" class="text-center">
                            ...
                            <td class="px-4 py-2">
                                {{ $product_size->pivot->quantity }} unidades
                            </td>
                            ...
                            <td class="px-4 py-2 flex">
                                <x-secondary-button class="ml-auto mr-2" wire:loading.attr="disabled"
                                    wire:target="edit()" wire:click="edit({{ $product_size->pivot->id }})">
                                    Actualizar
                                </x-secondary-button>
                                ...
                                <x-danger-button
                                    wire:click="$emit('deleteProductSize', {{ $product_size->pivot->id }})">
                                    Eliminar
                                </x-danger-button>
                            </td>
                        </tr>
